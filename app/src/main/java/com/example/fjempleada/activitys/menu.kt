...
import com.example.fjempleada.activitys.ui.*
...
class menu : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appBarConfiguration = AppBarConfiguration(
            setOf(
                ...
                R.id.nav_historial, R.id.nav_CV, R.id.nav_sesion,R.id.nav_documentos
            ), drawerLayout
        )
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId){
            ...
            R.id.nav_historial->{ LoadFragment(Publicacion())}
            R.id.nav_documentos->{LoadFragment(Documentos())}
            R.id.nav_sesion->{
